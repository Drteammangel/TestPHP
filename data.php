...
echo("$user_name");
$sql = "insert into user_info(user_name, user_sex, user_grade, user_degree, user_comment, user_avatar) values ('" . $user_name . "','" . $user_sex . "','" . $user_grade . "','" . $user_degree . "','" . $user_comment . "','" . $user_avatar . "')";
